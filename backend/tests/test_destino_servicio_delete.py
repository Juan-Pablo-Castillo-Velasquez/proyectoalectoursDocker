...
La fixture `db` (SQLite en memoria) vive en conftest.py, compartida por
toda la suite -- llamando directo a la función de la ruta (no hay capa de
repositorio para Destino/Servicio) con un admin_id ficticio, sin pasar por
FastAPI ni HTTP.
"""
